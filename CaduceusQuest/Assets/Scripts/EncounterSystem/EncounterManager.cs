            ...
            if (EncounterGoals[i].ActionName == actionName)
            {
                if (i == 0)
                {
                    ...
                    if (_target1SuccessCount == EncounterGoals[i].TreatmentCount)
                    {
                        ...
                        for (int j = 0; j < _theGameManager.CurrentEvents.Count; j++)
                        {
                            foreach (EventGoal eg in _theGameManager.CurrentEvents[j].EventGoals)
                            {
        ...
        for (int i = 0; i < 4; i++)
        {
            if (i <= CurrentEncounter.GoalCount - 1)
            {
                if (i == 0)
                {
                    ...
                    _theGameManager.AddSkill(EncounterGoals[i].ActionName, EncounterGoals[i].ActionType);
